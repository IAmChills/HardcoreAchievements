local TARGET_NPC_ID = 448        -- set to nil for quest-only
local REQUIRED_QUEST_ID = 176     -- set to nil for kill-only
local MAX_LEVEL = 4
local ACH_ID = "Hogger"
