local TARGET_NPC_ID = 7318        -- set to nil for quest-only
local REQUIRED_QUEST_ID = 2561     -- set to nil for kill-only
local MAX_LEVEL = 10
local ACH_ID = "Rageclaw"
local FACTION = "Horde"
local RACE = nil
local CLASS = nil
...
function Rageclaw_Kill(destGUID)
  RestoreFromProgress()
...
function Rageclaw_Quest(questID)
  RestoreFromProgress()
  if state.completed or not BelowMax() then return false end
