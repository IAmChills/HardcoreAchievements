local TARGET_NPC_ID = 2714        -- set to nil for quest-only
local REQUIRED_QUEST_ID = 658     -- set to nil for kill-only
local MAX_LEVEL = 35
local ACH_ID = "ForsakenCourier"
...
function ForsakenCourier_Kill(destGUID)
  RestoreFromProgress()
...
function ForsakenCourier_Quest(questID)
  RestoreFromProgress()
  if state.completed or not BelowMax() then return false end
...
function ForsakenCourier_IsCompleted()
