local TARGET_NPC_ID = 2091        -- set to nil for quest-only
local REQUIRED_QUEST_ID = 474     -- set to nil for kill-only
local MAX_LEVEL = 32
local ACH_ID = "Nekrosh"
...
function Nekrosh_Kill(destGUID)
  RestoreFromProgress()
...
function Nekrosh_Quest(questID)
  RestoreFromProgress()
  if state.completed or not BelowMax() then return false end
