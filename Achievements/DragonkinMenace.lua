...
local REQUIRED_QUEST_ID = 4182     -- set to nil for kill-only
local MAX_LEVEL = 58
local ACH_ID = "DragonkinMenace"
...
function DragonkinMenace_Kill(destGUID)
  RestoreFromProgress()
...
function DragonkinMenace_Quest(questID)
  RestoreFromProgress()
  if state.completed or not BelowMax() then return false end
...
function DragonkinMenace_IsCompleted()
