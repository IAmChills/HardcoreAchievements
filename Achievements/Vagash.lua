local TARGET_NPC_ID = 1388        -- set to nil for quest-only
local REQUIRED_QUEST_ID = 314     -- set to nil for kill-only
local MAX_LEVEL = 4
local ACH_ID = "Vagash"
