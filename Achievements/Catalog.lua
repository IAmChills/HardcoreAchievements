...
{ achId="Test2", title="Easy Quest Test", level=2, tooltip="Orc starter quest", icon=134400, points=10, requiredQuestId=123, targetNpcId=nil, faction="Horde", zone="Durotar" },
{ achId="Test3", title="Kill + Quest", level=3, tooltip="Kill a boar and complete the orc starter quest", icon=134400, points=10, requiredQuestId=123, targetNpcId=3098, faction="Horde", zone="Durotar" },
{ achId="Test4", title="Kill 3 Boars", level=4, tooltip="Kill 3 boars", icon=134400, points=10, requiredQuestId=nil, requiredKills = { [3098] = 3, }, faction="Horde", zone="Durotar" },
