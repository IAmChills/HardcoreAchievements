...
local REQUIRED_QUEST_ID = 2882     -- set to nil for kill-only
local MAX_LEVEL = 46
local ACH_ID = "CuergosGold"
...
function CuergosGold_Kill(destGUID)
  RestoreFromProgress()
...
function CuergosGold_Quest(questID)
  RestoreFromProgress()
  if state.completed or not BelowMax() then return false end
...
function CuergosGold_IsCompleted()
