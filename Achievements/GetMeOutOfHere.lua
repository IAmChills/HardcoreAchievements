...
local REQUIRED_QUEST_ID = 6132     -- set to nil for kill-only
local MAX_LEVEL = 42
local ACH_ID = "GetMeOutOfHere"
...
function GetMeOutOfHere_Kill(destGUID)
  RestoreFromProgress()
...
function GetMeOutOfHere_Quest(questID)
  RestoreFromProgress()
  if state.completed or not BelowMax() then return false end
...
function GetMeOutOfHere_IsCompleted()
