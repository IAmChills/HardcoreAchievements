local TARGET_NPC_ID = 10041        -- set to nil for quest-only
local REQUIRED_QUEST_ID = 4507     -- set to nil for kill-only
local MAX_LEVEL = 57
local ACH_ID = "GorishiHiveQueen"
...
function GorishiHiveQueen_Kill(destGUID)
  RestoreFromProgress()
...
function GorishiHiveQueen_Quest(questID)
  RestoreFromProgress()
  if state.completed or not BelowMax() then return false end
...
function GorishiHiveQueen_IsCompleted()
