local TARGET_NPC_ID = 703        -- set to nil for quest-only
local REQUIRED_QUEST_ID = 180     -- set to nil for kill-only
local MAX_LEVEL = 24
local ACH_ID = "Fangore"
...
function Fangore_Kill(destGUID)
  RestoreFromProgress()
...
function Fangore_Quest(questID)
  RestoreFromProgress()
  if state.completed or not BelowMax() then return false end
