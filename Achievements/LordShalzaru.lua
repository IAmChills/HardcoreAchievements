local TARGET_NPC_ID = 8136        -- set to nil for quest-only
local REQUIRED_QUEST_ID = 2870     -- set to nil for kill-only
local MAX_LEVEL = 44
local ACH_ID = "LordShalzaru"
...
function LordShalzaru_Kill(destGUID)
  RestoreFromProgress()
...
function LordShalzaru_Quest(questID)
  RestoreFromProgress()
  if state.completed or not BelowMax() then return false end
...
function LordShalzaru_IsCompleted()
