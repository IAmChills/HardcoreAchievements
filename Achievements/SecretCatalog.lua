    ...
    -- Secret Achievements
{
    ...
    level = nil,
    tooltip = "You have completed the secret achievement: |cff008765Kill a rat|r",
    ...
    level = nil,
    tooltip = "You have completed the secret achievement: |cff008765Drink some Noggenfogger|r",
    icon = 134863,
    points = 0,
    customIsCompleted = function() return false end,
    customSpell = function(spellId, targetName)
    ...
    level = nil,
    tooltip = "You have completed the secret achievement: |cff008765Pet Spot the Wolf|r",
    icon = 132203,
    points = 0,
    faction = FACTION_ALLIANCE,
    customIsCompleted = function() return false end,
    ...
    title = "Mak'gora",
    level = nil,
    tooltip = "Obtain an ear by winning a |cff008765Mak'gora|r",
    icon = 133854,
    points = 0,
    customIsCompleted = function() return false end,
    customAura = function()
...
-- },
{
    ...
    title = "Jump Master",
    level = nil,
    tooltip = "You have completed the secret achievement: |cff008765Jump 100,000 times|r",
    ...
    level = nil,
    tooltip = "You have completed the secret achievement: |cff008765Obtain the Forest Leather Belt|r",
    icon = 132492,
    points = 0,
    customIsCompleted = function() return false end,
