local TARGET_NPC_ID = 1205        -- set to nil for quest-only
local REQUIRED_QUEST_ID = 217     -- set to nil for kill-only
local MAX_LEVEL = 17
local ACH_ID = "Grawmug"
...
function Grawmug_Kill(destGUID)
  RestoreFromProgress()
...
function Grawmug_Quest(questID)
  RestoreFromProgress()
  if state.completed or not BelowMax() then return false end
