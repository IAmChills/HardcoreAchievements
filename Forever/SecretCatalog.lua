...
-- UnitBuff was removed in retail 11.0; Utils\Compat.lua bridges to C_UnitAuras.
...
local Secrets = {
{
  ...
  hiddenUntilComplete = true,
    ...
    firstKillRareQuestLoot = {
      ...
      { itemId = 10458, questId = 3378, npcIds = { 8419, 5860, 5861, 5862 } },     -- Prayer to Elune / Prayer to Elune [Alliance]
