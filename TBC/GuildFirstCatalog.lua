...
local achievements = {
  {
    ...
    -- Checked against the guild roster so guildmates without the addon still count as having beaten us.
    requiresNoGuildmateAtLevel = 70,
    awardMode = "solo",
    ...
    achId = "GF201",
    title = "Guild First: Karazhan",
    level = nil,
    tooltip = "You were the first in your guild to complete Karazhan.",
    icon = "Interface\\AddOns\\HardcoreAchievements\\Images\\Icons\\guild_first.png",
    points = 0,
    staticPoints = true,
    triggerAchievementId = "KARA",
    awardMode = "raid",
    requireSameGuild = true,
  }, {
    achId = "GF202",
    title = "Guild First: Gruul's Lair",
    level = nil,
    tooltip = "You were the first in your guild to complete Gruul's Lair.",
    icon = "Interface\\AddOns\\HardcoreAchievements\\Images\\Icons\\guild_first.png",
    points = 0,
    staticPoints = true,
    triggerAchievementId = "GRUUL",
    awardMode = "raid",
    requireSameGuild = true,
  }, {
    achId = "GF203",
    title = "Guild First: Magtheridon's Lair",
    level = nil,
    tooltip = "You were the first in your guild to complete Magtheridon's Lair.",
    icon = "Interface\\AddOns\\HardcoreAchievements\\Images\\Icons\\guild_first.png",
    points = 0,
    staticPoints = true,
    triggerAchievementId = "MAGTHERIDON",
    awardMode = "raid",
    requireSameGuild = true,
  }, {
    achId = "GF204",
    title = "Guild First: Serpentshrine Cavern",
    level = nil,
    tooltip = "You were the first in your guild to complete Serpentshrine Cavern.",
    icon = "Interface\\AddOns\\HardcoreAchievements\\Images\\Icons\\guild_first.png",
    points = 0,
    staticPoints = true,
    triggerAchievementId = "SSC",
    awardMode = "raid",
    requireSameGuild = true,
  }, {
    achId = "GF205",
    title = "Guild First: Tempest Keep",
    level = nil,
    tooltip = "You were the first in your guild to complete Tempest Keep.",
    icon = "Interface\\AddOns\\HardcoreAchievements\\Images\\Icons\\guild_first.png",
    points = 0,
    staticPoints = true,
    triggerAchievementId = "TK",
    awardMode = "raid",
    requireSameGuild = true,
  }, {
    achId = "GF206",
    title = "Guild First: Hyjal Summit",
    level = nil,
    tooltip = "You were the first in your guild to complete Hyjal Summit.",
    icon = "Interface\\AddOns\\HardcoreAchievements\\Images\\Icons\\guild_first.png",
    points = 0,
    staticPoints = true,
    triggerAchievementId = "HYJAL",
    awardMode = "raid",
    requireSameGuild = true,
  }, {
    achId = "GF207",
    title = "Guild First: Black Temple",
    level = nil,
    tooltip = "You were the first in your guild to complete Black Temple.",
    icon = "Interface\\AddOns\\HardcoreAchievements\\Images\\Icons\\guild_first.png",
    points = 0,
    staticPoints = true,
    triggerAchievementId = "BT",
    awardMode = "raid",
    requireSameGuild = true,
  }, {
    achId = "GF208",
    title = "Guild First: Zul'Aman",
    level = nil,
    tooltip = "You were the first in your guild to complete Zul'Aman.",
    icon = "Interface\\AddOns\\HardcoreAchievements\\Images\\Icons\\guild_first.png",
    points = 0,
    staticPoints = true,
    triggerAchievementId = "ZA",
    awardMode = "raid",
    requireSameGuild = true,
  }, {
    achId = "GF209",
    title = "Guild First: Sunwell Plateau",
    level = nil,
    tooltip = "You were the first in your guild to complete Sunwell Plateau.",
    icon = "Interface\\AddOns\\HardcoreAchievements\\Images\\Icons\\guild_first.png",
    points = 0,
    staticPoints = true,
    triggerAchievementId = "SWP",
    awardMode = "raid",
    requireSameGuild = true,
  },
}
...
if addon then
  ...
  for _, def in ipairs(achievements) do
    -- These live in their own "Guild" dashboard tab rather than under Secret, so they keep their
    -- real titles and tooltips and stay visible before anyone claims them. Rows for entries
    -- already won by another guild member are hidden by the claim check in HardcoreAchievements.lua.
