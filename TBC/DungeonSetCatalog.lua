...
local DungeonSets = {
  -- DEADMINES
  {
    ...
    level = 24,
    tooltip = "Equip the " .. HCA_SharedUtils.GetClassColor() .. "Blackened Defias Set|r before level 25",
    icon = 132723,
    points = 50,
  ...
  -- WAINING CAVERNS
  {
    ...
    level = 25,
    tooltip = "Equip the " .. HCA_SharedUtils.GetClassColor() .. "Embrace of the Viper Set|r before level 26",
    icon = 135020,
    points = 50,
  ...
  -- SCARLET MONASTERY
  {
    ...
    level = 45,
    tooltip = "Equip the " .. HCA_SharedUtils.GetClassColor() .. "Chain of the Scarlet Crusade Set|r before level 46",
    icon = 132629,
    points = 60,
  ...
  -- SCHOLOMANCE
  {
    ...
    level = 60,
    tooltip = "Equip the " .. HCA_SharedUtils.GetClassColor() .. "Bloodmail Regalia Set|r",
    icon = 132960,
    points = 50,
    ...
    level = 60,
    tooltip = "Equip the " .. HCA_SharedUtils.GetClassColor() .. "Cadaverous Garb Set|r",
    icon = 132718,
    points = 50,
    ...
    level = 60,
    tooltip = "Equip the " .. HCA_SharedUtils.GetClassColor() .. "Deathbone Guardian Set|r",
    icon = 132637,
    points = 50,
    ...
    level = 60,
    tooltip = "Equip the " .. HCA_SharedUtils.GetClassColor() .. "Necropile Raiment Set|r",
    icon = 132684,
    points = 50,
    ...
    level = 60,
    tooltip = "Equip the " .. HCA_SharedUtils.GetClassColor() .. "Postmaster's Set|r",
    icon = 132725,
    points = 50,
  ...
  -- BLACKROCK SPIRE
  {
    ...
    level = 60,
    tooltip = "Equip the " .. HCA_SharedUtils.GetClassColor() .. "Ironweave Battlesuit Set|r",
    icon = 132689,
    points = 80,
  ...
  -- BLACKROCK DEPTHS
  {
    ...
    level = 60,
    tooltip = "Equip the " .. HCA_SharedUtils.GetClassColor() .. "The Gladiator Set|r",
    icon = 132637,
    points = 50,
  ...
  -- HUNTER
  {
    ...
    level = 60,
    tooltip = "Equip the " .. HCA_SharedUtils.GetClassColor() .. "Beaststalker's Armor Set|r",
    icon = 132625,
    points = 100,
    ...
    level = 60,
    tooltip = "Equip the " .. HCA_SharedUtils.GetClassColor() .. "Beastmaster's Armor Set|r",
    icon = 132625,
    points = 200,
  ...
  -- MAGE
  {
    ...
    level = 60,
    tooltip = "Equip the " .. HCA_SharedUtils.GetClassColor() .. "Magister's Regalia Set|r",
    icon = 132666,
    points = 100,
    ...
    level = 60,
    tooltip = "Equip the " .. HCA_SharedUtils.GetClassColor() .. "Sorcerer's Regalia Set|r",
    icon = 132666,
    points = 200,
  ...
  -- DRUID
  {
    ...
    level = 60,
    tooltip = "Equip the " .. HCA_SharedUtils.GetClassColor() .. "Wildheart Raiment Set|r",
    icon = 132741,
    points = 100,
    ...
    level = 60,
    tooltip = "Equip the " .. HCA_SharedUtils.GetClassColor() .. "Feralheart Raiment Set|r",
    icon = 132741,
    points = 200,
  ...
  -- WARRIOR
  {
    ...
    level = 60,
    tooltip = "Equip the " .. HCA_SharedUtils.GetClassColor() .. "Battlegear of Valor Set|r",
    icon = 132738,
    points = 100,
    ...
    level = 60,
    tooltip = "Equip the " .. HCA_SharedUtils.GetClassColor() .. "Battlegear of Heroism Set|r",
    icon = 132738,
    points = 200,
  ...
  -- PRIEST
  {
    ...
    level = 60,
    tooltip = "Equip the " .. HCA_SharedUtils.GetClassColor() .. "Vestments of the Devout Set|r",
    icon = 132652,
    points = 100,
    ...
    level = 60,
    tooltip = "Equip the " .. HCA_SharedUtils.GetClassColor() .. "Vestments of the Virtuous Set|r",
    icon = 132652,
    points = 200,
  ...
  -- WARLOCK
  {
    ...
    level = 60,
    tooltip = "Equip the " .. HCA_SharedUtils.GetClassColor() .. "Dreadmist Raiment Set|r",
    icon = 132690,
    points = 100,
    ...
    level = 60,
    tooltip = "Equip the " .. HCA_SharedUtils.GetClassColor() .. "Deathmist Raiment Set|r",
    icon = 132690,
    points = 200,
  ...
  -- PALADIN
  {
    ...
    level = 60,
    tooltip = "Equip the " .. HCA_SharedUtils.GetClassColor() .. "Lightforge Armor Set|r",
    icon = 132738,
    points = 100,
    ...
    level = 60,
    tooltip = "Equip the " .. HCA_SharedUtils.GetClassColor() .. "Soulforge Armor Set|r",
    icon = 132738,
    points = 200,
  ...
  -- ROGUE
  {
    ...
    level = 60,
    tooltip = "Equip the " .. HCA_SharedUtils.GetClassColor() .. "Shadowcraft Armor Set|r",
    icon = 132722,
    points = 100,
    ...
    level = 60,
    tooltip = "Equip the " .. HCA_SharedUtils.GetClassColor() .. "Darkmantle Armor Set|r",
    icon = 132722,
    points = 200,
  ...
  -- SHAMAN
  {
    ...
    level = 60,
    tooltip = "Equip the " .. HCA_SharedUtils.GetClassColor() .. "The Elements Set|r",
    icon = 132633,
    points = 100,
    ...
    level = 60,
    tooltip = "Equip the " .. HCA_SharedUtils.GetClassColor() .. "The Five Thunders Set|r",
    icon = 132633,
    points = 200,
