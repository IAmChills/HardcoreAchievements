...
-- Alliance
{
    ...
    icon = "Interface\\AddOns\\HardcoreAchievements\\Images\\Icons\\Ability_Rogue_SurpriseAttack.png", -- 132308
    points = 10,
...
-- Horde (new)
{
    ...
    icon = "Interface\\AddOns\\HardcoreAchievements\\Images\\Icons\\inv_misc_crate01.png", -- 1518638
    points = 10,
    ...
    level = 28,
    tooltip = "Complete " .. ClassColor .. "Battle of Hillsbrad Pt. 6|r before level 29",
...
-- Neutral (no faction)
{
    ...
    icon = "Interface\\AddOns\\HardcoreAchievements\\Images\\Icons\\Achievement_Dungeon_RixxaFluxfume.png", -- 2011135
    points = 10,
    allowSoloDouble = true,
    ...
    level = 50,
    tooltip = "Complete " .. ClassColor .. "An OOX of Your Own|r before level 51",
    icon = 133883,
    points = 10,
    allowSoloDouble = true,
...
local function IsEligible(def)
  -- Faction: FACTION_ALLIANCE / FACTION_HORDE (localized) or english "Alliance"/"Horde"
